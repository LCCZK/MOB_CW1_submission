...
class PFLocaliser(PFLocaliserBase):
    ...
    def __init__(self, logger, clock):
        ...
        self.POSE_STD_THRESHOLD_TO_RESAMPLE = (0.2, 0.2, 0.25*math.pi)
        self.RESAMPLE_NOISE = (0.3, 0.3, 0.2*math.pi)
        
        # Noisy resampaling params
        self.POSE_STD_THRESHOLD_TO_NOISY_RESAMPLE = (1, 1, 0.5*math.pi)
        self.MEAN_PARTICLE_WEIGHT_THRESHOLD_TO_NOISY_RESAMPLE = 10
        self.NOISY_RESAMPLE_NOISE = (10, 10, 0.8*math.pi)
